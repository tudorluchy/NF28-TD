...
public class Console {
	...
	public static String PROPERTY_UPDATE_VIEW_1 = "image";
	public static String PROPERTY_UPDATE_VIEW_2 = "image2";
	...
	public void time(String view) {
		if (view.equals("view1")) {
			pcs.firePropertyChange(PROPERTY_UPDATE_VIEW_1, null, getImage());
		} else if (view.equals("view2")) {
			pcs.firePropertyChange(PROPERTY_UPDATE_VIEW_2, null, getImage2());
		}
	}
